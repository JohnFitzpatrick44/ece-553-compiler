...
val openString = false 
fun update pos = linePos := pos

fun eof() = let val pos = hd(!linePos) in if openString then ErrorMsg.error pos ("open string at end of file") else Tokens.EOF(pos,pos) end
