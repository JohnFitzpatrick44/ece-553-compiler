        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ107(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"`"
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ108(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ110(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction42(strm, yyNO_MATCH)
                      else yyQ112(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp = #"`"
              then yyAction42(strm, yyNO_MATCH)
            else if inp < #"`"
              then if inp = #"_"
...
fun yyQ37 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ113(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"@"
              then yyQ15(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"@"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"5"
              ...
              then if inp <= #"/"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ16(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
fun yyQ12 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ16(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"0"
              then yyAction61(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ16(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
...
fun yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ12(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp < #"0"
              then if inp = #"\^N"
                  then yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp < #"\^N"
                  then if inp = #"\n"
                      then yyQ10(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp < #"\n"
                      then if inp = #"\t"
                          then yyQ9(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                          else yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp = #"\r"
                      then yyQ9(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                      else yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp = #"!"
                  ...
                  then yyQ11(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                  else yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp = #"^"
              then yyQ14(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp < #"^"
              then if inp = #"3"
                  then yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp < #"3"
                  then if inp = #"2"
                      then yyQ13(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                      else yyQ12(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp = #"\\"
                  then yyQ11(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                  else yyQ8(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp = #"o"
